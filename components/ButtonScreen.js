  ...
  render() {
    ...
    <View style={styles.background}>
        ...
        <TouchableOpacity style={styles.buttons} onPress={()=>{
            ...
            }}><Text style={styles.buttonText}>Buy a Gift Card</Text></TouchableOpacity>
        <TouchableOpacity style={styles.buttons} onPress={()=>{
                navigate('Scan Gift Cards')
            }}><Text style={styles.buttonText}>Scan A Gift Card</Text></TouchableOpacity>
        <TouchableOpacity onPress={()=>{
                navigate('About')
            }}><Text style={styles.buttonTextAbove}>About Us</Text></TouchableOpacity>
        <TouchableOpacity onPress={()=>{
                navigate('Login')
            }}><Text style={styles.buttonTextUnder}>Logout</Text></TouchableOpacity>
    </View>
    );
  }
}
